...
const DocumentProcessor = () => {
  ...
  const handleSendMessage = async (message: string): Promise<string> => {
    ...
    try {
      ...
      const data = await response.json();
      return data.answer;  // Ensure the backend returns a string
    } catch (error) {
      console.error('Error:', error);
      return 'Sorry, I couldn\'t process your request. Please try again later.'; // Return a fallback string
    }
  };
